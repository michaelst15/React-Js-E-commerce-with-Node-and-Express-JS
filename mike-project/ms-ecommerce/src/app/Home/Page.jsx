    ...
    return(
     <div>
       <div className='block-one'>
         <div className='label-web d-flex'>          
          ...
          <div className='block-four'>
            <div className='about'>
              <div className="container bg-white" style={{marginTop: '-20px'}}>
                <h3 className="fw-bold fst-italic mb-4" id='Learn' style={{fontFamily: 'Quattrocento, serif'}}>MIKe.Store</h3>
                <p className='mb-5' style={{fontFamily: 'Quattrocento, serif'}}>Anda dapat menemukan koleksi jam tangan yang bervariasi dan dengan gaya beragam yang anda sesuaikan 
                ...
                <hr />                                                                               
                <h2 className="text-center mt-5 mb-5" style={{fontFamily: 'Quattrocento, serif'}}>MIKe.Store Collection</h2>
              <div className="card-mike-colect container bg-white d-flex text-center">
                <div className='row'>
                ...
                <div className="card-mike-colect container bg-white d-flex text-center mt-5">
                  <div className='row'>
                      <div className='col-md-6'>
                        <Card style={{backgroundColor: '#004CE6', color: 'white', borderRadius: '20px'}}>
